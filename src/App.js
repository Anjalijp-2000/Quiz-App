    ...
    <div className="App">
      ...
      {showFinalResults ? (
        <div className="final-results">
          ...
          <h2> You have successfully Answered the Questions!! </h2>
          <p> <b>Question asked :</b> {questions.length}</p>
          <p> <b>Question corrected :</b> {score}</p>
          ...
          <div className="col-md-6 question-card p-3">
            <div className="d-grid gap-2 d-md-flex justify-content-md-end">
              <div className="button-section text-right mb-3">
                ...
                {currentQuestion > 0 && (
                  <button
                    className="text-light btn   me-md-4" style={{backgroundColor:'#236675'}}
                ...
                {currentQuestion < questions.length - 1 && (
                  <button
                    className="text-light btn " style={{backgroundColor:'#236675'}}
                    onClick={() => setCurrentQuestion(currentQuestion + 1)}
                  >
                    Next
                  </button>
